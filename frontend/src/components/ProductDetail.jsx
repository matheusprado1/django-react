    ...
    <section className="container mt-4">
      <div className="row">
        ...
        <div className="col-8">
          ...
          <h5 className="card-title">Preço: R$ 500</h5>
          <p className="mt-3">
            ...
            <button title="Add to cart" className="btn btn-primary ms-1">
              <i className="fa-solid fa-cart-plus"></i> Add ao Carrinho
            </button>
            <button title="buy Now" className="btn btn-success ms-1">
              <i className="fa-solid fa-bag-shopping"></i> Comprar agora
            </button>
            <button title="Add to Wishlist" className="btn btn-danger ms-1">
              <i className="fa fa-heart"></i> Favoritar
            </button>
          </p>
          <div className="producttags mt-4">
            ...
            <p>
              ...
              <Link to="#" className="badge bg-secondary text-white">
                web scripts
              </Link>
            </p>
          </div>
      ...
      {/* Related Products */}
      <h3 className="mt-5 mb-3">Produtos Relacionados</h3>
      <div
